...
render_mobius_animation(v, theta, t; output="demo.mp4", nframes=120, quality=:medium)
```
...
See `Laura.org` for additional runnable examples and demo workflows.
...
render_mobius_animation(coeffs...; output="loxodromic.mp4", nframes=120)
```
...
v, theta, t = params
render_mobius_animation(v, theta, t; output="from_tuple.mp4", nframes=120)
```
